...
#this function takes a word from the given test list and selects one that the user must guess correctly
def word_bank():
...
def create_lists(word):
    ...
    return puzzle, word_as_list, letter_list #send puzzle and word_as_list back for use
...
#this function decides if the game is over or not based on if the length of the word_as_list and letter_list are the same
